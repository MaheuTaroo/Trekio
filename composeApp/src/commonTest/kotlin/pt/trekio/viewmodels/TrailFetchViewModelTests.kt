...
class TrailFetchViewModelTests {
    ...
    @Test
    fun `ViewModel starts and stays in Idle state if nothing is executed`() = runTest {
    ...
    @Test
    fun `ViewModel goes into Loading state immediately after executing fetchPage`() = runTest {
    ...
    @Test
    fun `ViewModel goes into Error state if there's an error incoming from service about the execution of fetchPage`() = runTest {
    ...
    @Test
    fun `ViewModel goes into TrailsSuccess state if the execution of fetchPage is successful`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Loading state immediately after executing fetchTrailsByName`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Error state if there's an error incoming from service about the execution of fetchTrailsByName`() = runTest {
    ...
    @Test
    fun `ViewModel goes into TrailsSuccess state if the execution of fetchTrailsByName is successful`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Loading state immediately after executing fetchPersonalTrails`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Error state if there's an error about the user's details gathering at fetchPersonalTrails`() = runTest {
        val vm = TrailFetchViewModel(FailingService, FailingService)
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Error state if there's an error incoming from service about the execution of fetchPersonalTrails`() = runTest {
        val vm = TrailFetchViewModel(SuccessfulUserRepo, FailingService)
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into TrailsSuccess state if the execution of fetchPersonalTrails is successful`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Loading state immediately after executing deleteTrail`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Error state if there's an error incoming from service about the execution of deleteTrail`() = runTest {
        val vm = TrailFetchViewModel(SuccessfulUserRepo, FailingService)
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Success state if the execution of deleteTrail is successful`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Loading state immediately after executing updateTrail`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into UpdateError state if there's an error incoming from service about the execution of updateTrail`() = runTest {
        val vm = TrailFetchViewModel(SuccessfulUserRepo, FailingService)
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
    ...
    @Test
    fun `ViewModel goes into Success state if the execution of updateTrail is successful`() = runTest {
        var result: TrailFetchState? = null
        val latch = SuspendingLatch()
