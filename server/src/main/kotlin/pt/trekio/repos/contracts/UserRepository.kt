...
abstract class UserRepository {
     ...
     */
    abstract suspend fun getUserById(id: ULong): User?
     ...
     * @return The user's information, or ``null`` if none exists,
     */
    abstract suspend fun getUserByName(username: Username): User?
     ...
     * @return The user's information, or ``null`` if none exists,
     */
    abstract suspend fun getUserByEmail(email: Email): User?
     ...
     * @return The cause of failure, or nothing in case of success.
     */
    abstract suspend fun deleteUser(username: Username): Either<UserError, Unit>
     ...
     */
    abstract suspend fun getUserByTokenValidationInfo(tokenValidationInfo: String): Pair<User, Token>?
     ...
     * @return The cause of failure, or nothing in case of success.
     */
    abstract suspend fun createToken(
        token: Token,
        maxTokens: Int,
